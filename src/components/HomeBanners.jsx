...
const HomeBanners = () => {
  ...
  return (
    <section className='relative h-[calc(78svh+85px)] min-h-[625px] overflow-hidden bg-neutral-950 pt-18 sm:h-[calc(78svh+32px)] sm:min-h-[652px] lg:h-[calc(78svh+52px)] lg:min-h-[672px]'>
      <div
